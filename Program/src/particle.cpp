...
This file contains the constructor for the particle class.
*/

#include "particle.h"

particle::particle(double xin, double yin, double zin, int icell_in) {
    x = xin; y=yin; z = zin; cell_id = icell_in;
}